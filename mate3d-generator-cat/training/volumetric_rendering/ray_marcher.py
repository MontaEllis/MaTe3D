...
class MipRayMarcher2(nn.Module):
    ...
    def run_forward(self, colors, densities, depths, rendering_options):
        ...
        # deltas = torch.cat([deltas, self.inf.expand((densities.shape[0],densities.shape[1],1,1))],-2)
        ...
        return composite_rgb, composite_depth, weights, densities


    def forward(self, colors, densities, depths, rendering_options):
        composite_rgb, composite_depth, weights, densities = self.run_forward(colors, densities, depths, rendering_options)
