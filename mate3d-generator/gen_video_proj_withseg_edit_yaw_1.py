    ...
    for frame_idx in tqdm(range(num_keyframes * w_frames)):
        ...
        for yi in range(grid_h):
            for xi in range(grid_w):
                ...
                mask_3d_modify_2 = (1-(control3d_origin_max==2).cuda().int())
                mask_3d_modify_3 = (1-(control3d_max==2).cuda().int())
                ...
                mask_3d_modify = mask_3d_modify*mask_3d_modify_1*mask_3d_modify_2*mask_3d_modify_3#*mask_3d_modify_4*mask_3d_modify_5*mask_3d_modify_6*mask_3d_modify_7*mask_3d_modify_8*mask_3d_modify_9
                #############################################################################################
                
                # mask_3d_modify = erode_3d(dilate_3d(mask_3d_modify.cpu().float().unsqueeze(1),2),15).cuda()[:,0,:,:,:]
