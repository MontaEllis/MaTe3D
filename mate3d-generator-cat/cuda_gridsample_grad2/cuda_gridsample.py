...
import os, sys
sys.path.append('/openbayes/home/mate3d-generator/cuda_gridsample_grad2')



# gridsample_grad2 = load(name='gridsample_grad2', sources=['gridsample_cuda.cpp', 'gridsample_cuda.cu'], verbose=True)
gridsample_grad2 = load(name='gridsample_grad2', sources=['/openbayes/home/mate3d-generator/cuda_gridsample_grad2/gridsample_cuda.cpp', '/openbayes/home/mate3d-generator/cuda_gridsample_grad2/gridsample_cuda.cu'], verbose=True)
